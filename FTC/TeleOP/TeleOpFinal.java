...
//@TeleOp(name = "Final Teleop (No Threading)")
@Disabled
...
////////////////////////////////////////////////////////////////////////////////////////////////////
            // Glyph Coding //
                ...
                if (gamepad2.b) {
                    glyphLeftBottom.setPosition(0.5);
                    glyphRightBottom.setPosition(0.40);
                }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            // Relic Rotation Coding //
                RFT += gamepad2.right_stick_y/25;
                if(RFT > 1)
                    RFT = 1;
                if(RFT < 0)
                    RFT = 0;
                rotationRelic.setPosition(Rotation-RFT);
////////////////////////////////////////////////////////////////////////////////////////////////////
        }
    }
}