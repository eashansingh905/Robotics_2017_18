 ...
 */
@Autonomous (name = "Blue Corner(Two Glyphs)", group = "Blue Alliance")



public class BlueCornerTwoGlyphs extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        glyphMechanism.up();
        if (key.equals("RIGHT")) {
            drivetrain.drive(0.83, 0.3); //1.3
        } else if (key.equals("CENTER")) {
            drivetrain.drive(1.11, 0.3); //1.66
        } else if (key.equals("LEFT")) {
            drivetrain.drive(1.3, 0.3); // 0.83
        } else if (key.equals("UNKNOWN")) {
            //"CENTER" by default
